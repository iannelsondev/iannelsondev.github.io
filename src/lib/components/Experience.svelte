...
<div class="flex flex-col h-full">
  <div class="px-4 sm:px-6 md:px-8 pt-4 md:pt-6 max-w-7xl mx-auto w-full">
    <div class="font-mono tracking-[0.3em] uppercase text-[#6366f1] mb-2" style="font-size: clamp(0.6rem, 0.7vw, 0.75rem);">02 // Experience</div>
          ...
          <div class="p-5 md:p-8 lg:p-10 flex flex-col justify-center">
            ...
            <div class="flex items-start justify-between gap-4 mb-5 flex-wrap">
              <div class="flex items-center gap-4">
                ...
                >{entry.avatar}</div>
                <div>
                  <div class="font-semibold text-[#f1f5f9]" style="font-size: clamp(1.1rem, 1.3vw, 1.35rem);">{entry.role}</div>
