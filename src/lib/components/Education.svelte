  ...
  <div class="flex flex-col gap-4">
    {#each education as entry, i}
      <ScrollReveal delay={i * 100}>
        <div
          class="px-6 py-5 rounded-xl backdrop-blur-md flex items-center justify-between gap-6 flex-wrap
        ...
        >
          ...
          <div class="font-mono text-[0.65rem] tracking-[0.1em] text-[#94a3b8] whitespace-nowrap max-md:mt-1">{entry.years}</div>
        </div>
      </ScrollReveal>
    {/each}
  </div>
