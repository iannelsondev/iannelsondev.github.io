  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
    {#each skillCategories as category, i}
      <ScrollReveal delay={i % 2 === 0 ? 0 : 100}>
        <div
          class="p-6 rounded-xl backdrop-blur-md transition-all duration-250 hover:shadow-[0_8px_40px_rgba(99,102,241,0.1)] h-full"
        ...
        >
          ...
          <div class="flex flex-wrap gap-2" role="list" aria-label="{category.label} skills">
            {#each category.skills as skill}
              <span
                class="text-xs font-mono px-3 py-1 rounded-full text-[#94a3b8] transition-colors duration-150 hover:text-[#f1f5f9]"
