...
<section id="projects" class="py-28 px-8 max-w-5xl mx-auto" aria-labelledby="projects-heading">
  <div class="font-mono text-[0.6rem] tracking-[0.3em] uppercase text-[#6366f1] mb-2">04 // Projects</div>
  <h2 id="projects-heading" class="font-mono text-2xl font-bold tracking-wide text-[#f1f5f9] mb-12">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
    {#each projects as project, i}
      <ScrollReveal delay={i % 3 === 0 ? 0 : i % 3 === 1 ? 100 : 200}>
        <article
          class="p-7 rounded-xl backdrop-blur-md flex flex-col gap-3 transition-all duration-250
        ...
        >
          ...
          <p class="text-sm text-[#94a3b8] leading-relaxed">{project.description}</p>
        </article>
      </ScrollReveal>
    {/each}
  </div>
